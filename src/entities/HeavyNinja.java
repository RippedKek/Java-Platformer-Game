...
public class HeavyNinja extends Enemy {
	
	private int attackBoxOffsetX;

	public HeavyNinja(float x, float y) {
		super(x, y, HEAVY_NINJA_WIDTH_DEFAULT, HEAVY_NINJA_HEIGHT_DEFAULT, HEAVY_NINJA);
	...
	private void initAttackBox() {
		attackBox = new Rectangle2D.Float(x,y,25,30);
		attackBoxOffsetX = 25;
	}
